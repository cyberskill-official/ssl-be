...
import type { I_Input_Follow, I_Input_GetFollowers, I_Input_GetFollowings, I_Input_UnFollow } from './follow.type.js';

import { followCtr } from './follow.controller.js';

const followResolver = {
    Query: {
        getFollowers: (_parent: unknown, args: I_Input_FindPaging<I_Input_GetFollowers>, context: I_Context) => followCtr.getFollowers(context, args),
        getFollowings: (_parent: unknown, args: I_Input_FindPaging<I_Input_GetFollowings>, context: I_Context) => followCtr.getFollowings(context, args),
    },
    Mutation: {
