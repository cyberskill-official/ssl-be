...
export interface I_QueryMessageStatus extends I_MessageStatus { }

export interface I_MutateMessageStatus extends Omit<I_MessageStatus, 'id' | 'createdAt' | 'updatedAt' | 'message' | 'user'> { }
