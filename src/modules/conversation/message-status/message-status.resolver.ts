...
const messageStatusResolver = {
    ...
    Mutation: {
        ...
        deleteMessageStatuses: (_parent: unknown, args: I_Input_DeleteOne<I_Input_QueryMessageStatus>, context: I_Context) =>
            messageStatusCtr.deleteMessageStatuses(context, args),
        markAsRead: (_parent: unknown, { messageId, userId }: { messageId: string; userId: string }, _context: I_Context) =>
            messageStatusCtr.markAsRead(messageId, userId),
    },
};
