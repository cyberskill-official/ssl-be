...
function generateEmailTemplate(options: {
    ...
    const {
        ...
        message,
        buttonText = 'Sign in',
        buttonLink = 'https://secretswingerlust.com',
    ...
    const notificationPreferencesHtml = showNotificationPreferences
        ...
        <div style="margin-top:30px;">
            <h2 style="font-size:18px;font-weight:bold;color:#000000;margin:0 0 12px;font-family:Arial,Helvetica,sans-serif;">Want fewer emails?</h2>
            <p style="font-size:14px;color:#000000;margin:0 0 16px;line-height:1.6;font-family:Arial,Helvetica,sans-serif;">
                You're receiving this email because notifications are enabled on your Secretswingerlust profile.
            </p>
            <p style="font-size:14px;color:#000000;margin:0 0 12px;line-height:1.6;font-family:Arial,Helvetica,sans-serif;">
                It's easy to adjust your preferences:
            </p>
            <ol style="font-size:14px;color:#000000;margin:0 0 16px;padding-left:20px;line-height:1.8;font-family:Arial,Helvetica,sans-serif;">
                <li style="margin-bottom:8px;">
                    Sign in to <a href="https://secretswingerlust.com" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:underline;">Secretswingerlust.com</a>
                </li>
            ...
            <p style="font-size:14px;color:#000000;margin:0;line-height:1.6;font-weight:bold;font-family:Arial,Helvetica,sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width:600px;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="background-color:#631B1C;padding:30px 20px;text-align:center;">
                            <div style="color:#ffffff;font-size:32px;font-weight:bold;margin-bottom:5px;">SECRET</div>
                            <div style="color:#ffffff;font-size:18px;letter-spacing:2px;">SWINGERLUST</div>
                        </td>
                    </tr>
                    <!-- Main Content -->
                    <tr>
                        <td style="padding:40px 30px;background-color:#ffffff;">
                            <h1 style="font-size:28px;font-weight:bold;color:#000000;margin:0 0 20px;text-align:center;font-family:Arial,Helvetica,sans-serif;">${greeting}</h1>
                            ${title ? `<h2 style="font-size:20px;font-weight:bold;color:#000000;margin:0 0 16px;text-align:center;font-family:Arial,Helvetica,sans-serif;">${title}</h2>` : ''}
                            <div style="font-size:16px;color:#000000;margin:0 0 20px;text-align:center;line-height:1.6;font-family:Arial,Helvetica,sans-serif;">
                                ${message}
                            </div>
                            ${buttonHtml}
                            <p style="font-size:14px;color:#000000;margin:24px 0;text-align:right;font-family:Arial,Helvetica,sans-serif;">
                                Yours playfully,<br/>
                    ...
                    <tr>
                        <td style="background-color:#631B1C;padding:20px;text-align:center;">
                            <p style="color:#ffffff;font-size:14px;margin:0 0 10px;">For swingers - Created by swingers</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="background-color:#2a2a2a;padding:15px;text-align:center;">
                            <p style="color:#777877;font-size:12px;margin:0;">Secretswingerlust.com by JOLO Media ApS, Denmark.</p>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td align="center" style="padding:20px 0;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width:600px;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding:40px 30px;background-color:#ffffff;">
                            <h1 style="font-size:28px;font-weight:bold;color:#000000;margin:0 0 20px;text-align:center;font-family:Arial,Helvetica,sans-serif;">Hello <a href="mailto:<%= email %>" target="_blank" style="color:#000000;text-decoration:none;"><%= email %></a></h1>
                            <div style="font-size:16px;color:#000000;margin:0 0 20px;text-align:center;line-height:1.6;font-family:Arial,Helvetica,sans-serif;">
...
<body style="margin:0;padding:0;background-color:#f5f5f5;font-family:Arial,Helvetica,sans-serif;">
    ...
    },
    {
        ...
        content: generateEmailTemplate({
            ...
            message: `You have a new follower on <a href="https://secretswingerlust.com" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:none;">SecretSwingerLust.com</a>.`,
        }),
    },
    {
        ...
        content: generateEmailTemplate({
            title: '',
            message: `There's something new in your inbox on<br/><a href="https://secretswingerlust.com" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:none;">secretswingerlust.com</a>...<br/><br/><strong style="color:#000000;">Sign in to discover who's reaching out.</strong>`,
        }),
    },
    {
        ...
        content: generateEmailTemplate({
            ...
            message: `A new profile has just joined <a href="https://secretswingerlust.com" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:none;">secretswingerlust.com</a> in your area.`,
        }),
    },
    {
        ...
        content: generateEmailTemplate({
            ...
            message: `A new announcement has just been posted in your area on <a href="https://secretswingerlust.com" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:none;">SecretSwingerLust.com</a>.`,
        }),
    },
    {
        ...
        <tr>
            <td align="center" style="padding:20px 0;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width:600px;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding:40px 30px;background-color:#ffffff;">
                            <h1 style="font-size:28px;font-weight:bold;color:#000000;margin:0 0 20px;text-align:center;font-family:Arial,Helvetica,sans-serif;">Hello <a href="mailto:<%= email %>" target="_blank" rel="noopener noreferrer" style="color:#000000;text-decoration:none;"><%= email %></a>,</h1>
                            <div style="font-size:16px;color:#000000;margin:0 0 20px;line-height:1.6;font-family:Arial,Helvetica,sans-serif;">
