...
const TEMPLATE_UPDATES: Record<string, { subject: string; content: string; variables?: string[] }> = {
    [EMAIL_VERIFICATION]: {
        subject: '[<%= brandName %>] Verify your account',
        content: `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin:0;padding:0;background-color:#f5f5f5;font-family:Myanmar Text;">
    ...
    [NEW_MESSAGE]: {
        subject: '[<%= brandName %>] A new message awaits',
        content: generateEmailTemplate({
            title: '',
    ...
    [NEW_MEMBER_JOIN_IN_YOUR_AREA_INTEREST]: {
        subject: '[<%= brandName %>] A new profile just appeared near you 👋',
        content: generateEmailTemplate({
    ...
    [NEW_ANNOUNCEMENT_FOLLOWED_OR_NEARBY]: {
        subject: '[<%= brandName %>] A new announcement near you 📍',
        content: generateEmailTemplate({
    ...
    [ACCOUNT_DELETED]: {
        subject: '[<%= brandName %>] Your account has been deleted',
        content: generateEmailTemplate({
    ...
    [ACCOUNT_SUSPENDED]: {
        subject: '[<%= brandName %>] Your profile has been suspended',
        content: generateEmailTemplate({
    ...
    [PAYMENT_FAILED]: {
        subject: '[<%= brandName %>] Oops – something went wrong with your payment 💳',
        content: generateEmailTemplate({
    ...
    [PROFILE_DELETION_30_DAY]: {
        subject: '[<%= brandName %>] Your profile is at risk of deletion ⏱️',
        content: generateEmailTemplate({
    ...
    [PROFILE_DELETION_10_DAY]: {
        subject: '[<%= brandName %>] Final reminder – profile deletion in 10 days ⏳',
        content: generateEmailTemplate({
    ...
    [REPLY_FROM_ADMIN]: {
        subject: '[<%= brandName %>] Reply from admin: <%= reply_subject %>',
        content: `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin:0;padding:0;background-color:#f5f5f5;font-family:Myanmar Text;">
    ...
    [AGE_VERIFICATION_SKIPPED]: {
        subject: '[<%= brandName %>] Age Verification Skipped',
        content: generateEmailTemplate({
...
export async function up(db: C_Db) {
    ...
    const paymentResult = await emailCollection.updateOne(
        ...
        {
            $set: {
                subject: '[<%= brandName %>] Payment successful – receipt',
