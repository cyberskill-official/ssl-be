...
/**
 * Migration: Update email templates to include Secret® trademark symbol
 * and EU trademark statement in the footer.
 */
...
<body style="margin:0;padding:0;background-color:#f5f5f5;font-family:Myanmar Text;">
    ...
    'new-message': {
        ...
        content: generateEmailTemplate({
            ...
            <span style="color:#000000;padding:2px 4px;border-radius:3px;">Secret® Swinger Lust...</span><br/>
    ...
    'new-member-join-in-your-area-interest': {
        ...
        content: generateEmailTemplate({
            ...
            message: `A new profile has just joined <a href="${USER_APP_BASE_URL}/home" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:none;">Secret® Swinger Lust</a> in your area.`,
            showNotificationPreferences: true,
        }),
    },
    'new-announcement-followed-or-nearby': {
        ...
        content: generateEmailTemplate({
            ...
            message: `A new announcement has just been posted in your area on <a href="${USER_APP_BASE_URL}/home" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:none;">Secret® Swinger Lust</a>.`,
            showNotificationPreferences: true,
        }),
    },
    'account-deleted': {
    ...
    'membership-downgrade': {
        ...
        content: generateEmailTemplate({
            ...
            message: `Thank you for your time as a valued member of <a href="${USER_APP_BASE_URL}/home" target="_blank" rel="noopener noreferrer" style="color:#631B1C;text-decoration:none;">Secret® Swinger Lust</a> – we've truly enjoyed having you as part of our paying community.<br/><br/>Although you've chosen to end your membership, your profile remains active, and we hope you'll continue to explore and engage in our playful universe. You're still very much part of the Secret® Swinger Lust community!<br/><br/>Some features will no longer be available with your free profile – but there's still plenty of excitement waiting for you. And who knows… maybe you'll be tempted to upgrade again in the future 😉<br/><br/>Until then, we're happy to have you here.`,
            greeting: 'Hi there,',
            buttonText: '',
            buttonLink: '',
            showNotificationPreferences: false,
...
export async function up(db: C_Db) {
    ...
    for (const [templateKey, templateData] of Object.entries(TEMPLATE_UPDATES)) {
        ...
        if (result.modifiedCount > 0) {
            updatedCount++;
            log.info(`[trademark-update] Updated template: ${templateKey}`);
        }
    }

    log.success(`[trademark-update] Successfully updated ${updatedCount} email template(s) with Secret® trademark.`);
}

export async function down(_db: C_Db) {
    log.info('[trademark-update] Down migration is a no-op.');
}
