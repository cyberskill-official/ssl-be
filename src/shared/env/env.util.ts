...
import {
    ...
    ENDPOINT_WS,
    FROM_EMAIL_ADDRESS,
    MEMBERSHIP_EXTENSION_DAYS_OVERRIDE,
    MEMBERSHIP_EXTENSION_MINUTES_OVERRIDE,
    MONGO_BACKUP_FOLDER,
    MONGO_HOST,
    MONGO_PORT,
    PAYPAL_SUBSCRIPTION_INTERVAL_COUNT,
    PAYPAL_SUBSCRIPTION_INTERVAL_UNIT,
    PORT,
    REDIS_HOST,
    REDIS_PORT,
    ...
    SESSION_NAME_USER,
    STATIC_FOLDER,
    SUBSCRIPTION_RECONCILE_BATCH_SIZE,
    SUBSCRIPTION_RECONCILE_CONCURRENCY,
    SUBSCRIPTION_RENEWAL_GRACE_MINUTES,
    UPLOAD_FOLDER,
...
export function getEnv(): I_Environment {
    ...
    const cleanedEnv = cleanEnv(process.env, {
        ...
        MEMBERSHIP_EXTENSION_DAYS_OVERRIDE: num({ default: MEMBERSHIP_EXTENSION_DAYS_OVERRIDE }),
        MEMBERSHIP_EXTENSION_MINUTES_OVERRIDE: num({ default: MEMBERSHIP_EXTENSION_MINUTES_OVERRIDE }),
        PAYPAL_SUBSCRIPTION_INTERVAL_UNIT: str({
            choices: ['DAY', 'WEEK', 'MONTH', 'YEAR'],
            default: PAYPAL_SUBSCRIPTION_INTERVAL_UNIT,
        }),
        PAYPAL_SUBSCRIPTION_INTERVAL_COUNT: num({ default: PAYPAL_SUBSCRIPTION_INTERVAL_COUNT }),
        SUBSCRIPTION_RENEWAL_GRACE_MINUTES: num({ default: SUBSCRIPTION_RENEWAL_GRACE_MINUTES }),
        SUBSCRIPTION_RECONCILE_BATCH_SIZE: num({ default: SUBSCRIPTION_RECONCILE_BATCH_SIZE }),
        SUBSCRIPTION_RECONCILE_CONCURRENCY: num({ default: SUBSCRIPTION_RECONCILE_CONCURRENCY }),
        CRON_LOG_RETENTION_DAYS: num({ default: CRON_LOG_RETENTION_DAYS }),
        SUBSCRIPTION_STRICT_DOWNGRADE: str({ choices: ['true', 'false'], default: 'false' }),
